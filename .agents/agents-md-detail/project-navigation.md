...
All docs directories (`docs/`, `docs/architecture/`, `docs/ubiquitous-language/`, `docs/adr/`, etc.) have a `README.md` explaining that directory's contents and purpose — start there when entering a new directory.
